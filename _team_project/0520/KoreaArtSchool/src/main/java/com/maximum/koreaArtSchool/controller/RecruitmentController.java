...
public class RecruitmentController {
    ...
    public String getRecruitmentById(@PathVariable Integer id, Model model) {
        ...
        if (recruitment.isPresent()) {
            ...
            return "fragments/recruitment-details :: detail"; // Thymeleaf fragment 사용
        } else {
    ...
    @PostMapping("/save")
    public String saveRecruitment(@ModelAttribute Rcrt recruitment) {
        rcrtService.saveRecruitment(recruitment);

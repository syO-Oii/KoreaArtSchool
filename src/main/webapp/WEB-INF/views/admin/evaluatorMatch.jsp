    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">입학 전형 정보</h5>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form id="StageEvaluatorForm">
                            <div class="d-flex align-items-center justify-content-between">
                                <h5 class="card-title">평가위원 목록</h5>
                            </div>
                    ...
                    <div class="card-body">
                        <form id="StageApplicantForm">
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="apl" items="${stgApplicants}">
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input row-check" type="checkbox">
                                                <label class="form-check-label" for="gridCheck${apl.rcrt_no}">
                                                </label>
                                            </div>
                                        </td>
                                        <td>${apl.apl_no}</td>
                                        <td>${apl.apl_nm}</td>
                                        <td>
                                            <c:if test="${apl.gndr_cd == 10}">남</c:if>
                                            <c:if test="${apl.gndr_cd == 20}">여</c:if>
                                        </td>
                                        <td>
                                            <c:if test="${apl.dept_cd == 10}">시각디자인</c:if>
                                            <c:if test="${apl.dept_cd == 20}">무대영화미술</c:if>
                                            <c:if test="${apl.dept_cd == 30}">연기</c:if>
                                            <c:if test="${apl.dept_cd == 40}">모델</c:if>
                                            <c:if test="${apl.dept_cd == 50}">보컬</c:if>
                                            <c:if test="${apl.dept_cd == 60}">싱어송라이터</c:if>
                                        </td>
                                        <td>
                                            <c:if test="${apl.rcrt_cd == 10}">일반전형</c:if>
                                            <c:if test="${apl.rcrt_cd == 20}">특기생전형</c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
